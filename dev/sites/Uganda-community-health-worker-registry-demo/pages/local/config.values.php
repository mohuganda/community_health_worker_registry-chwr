 ...
 */
$i2ce_site_i2ce_path = "/var/lib/iHRIS/dev/4.3.3/i2ce";


/**
 * the dsn to connect to your databse
 */
$i2ce_site_dsn = 'mysql://chwr_manage:cencer69@localhost/chwrdemo' ;
 ...
 */
$i2ce_site_module_config = "/var/lib/iHRIS/dev/sites/Uganda-community-health-worker-registry-demo/Uganda-community-health-worker-registry-demo.xml";
